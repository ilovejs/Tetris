...
public class IPiece implements SquareConstants, Moveable{

    private Square _one, _two, _three, _four;
    private DrawingPanel _dp;

    public IPiece(DrawingPanel dp){
	_one = new Square(dp);
	_two = new Square(dp);
	...
	_three.setLocation(_one.getX(), _one.getY()+2*BOXSIZE);
	_four.setLocation(_one.getX(), _one.getY()+3*BOXSIZE);
